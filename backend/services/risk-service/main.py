"""
MFCALYTIX Risk Service — enterprise-grade risk analytics and reporting.
"""
...
def create_app() -> FastAPI:
    ...
    async def global_error_handler(request: Request, exc: Exception):
        ...
        return JSONResponse(
            status_code=500,
            content={"detail": "Internal risk engine error", "code": "internal_error"},
        )
    ...
    def health():
        ...
        return {"service": "risk-service", "status": "ok", "version": app.version, "database": db_status}
